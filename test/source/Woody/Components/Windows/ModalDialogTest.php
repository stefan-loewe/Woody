...
/**
 * Test class for ModalDialog.
 * Generated by PHPUnit on 2010-11-25 at 20:49:16.
 */
class ModalDialogTest extends \PHPUnit_Framework_TestCase {
  /**
   * @var ModalDialog
   */
  protected $window;
  ...
  /**
   * This method tests constructing the modal dialog.
   *
   * @covers \ws\loewe\Woody\Components\Windows\ModalDialog::__construct
   */
  public function testConstruct() {
    $this->window = new ModalDialog('ModalDialog', Point::createInstance(121, 343), Dimension::createInstance(987, 654));
