...
/**
 * Test class for NakedWindow.
 * Generated by PHPUnit on 2010-11-25 at 20:49:16.
 */
class NakedWindowTest extends \PHPUnit_Framework_TestCase {
  /**
   * @var NakedWindow
   */
  protected $window;
  ...
  /**
   * This method tests constructing the naked window.
   *
   * @covers \Woody\Components\Windows\NakedWindow::__construct
   */
